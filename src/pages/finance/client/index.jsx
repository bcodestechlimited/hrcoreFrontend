...
const CreateSoftwareDevelopment = () => {
	...
	let varAmount = 7.5,
		headerArr = ["project_name", "project_description"];
	...
	return (
		<div className="bg-[#EFF6FC] w-full px-4 py-8">
			<div className="flex items-center cursor-pointer ml-2">
				...
				<span>Create Software Development Invoices </span>
			</div>
			<BillToInvoice
				handleInputChangeCreateInvoice={handleInputChangeCreateInvoice}
				createInvoice={createInvoice}
			...
			<div className="flex w-full mt-10 gap-6">
				...
				<div className="w-[65%] ">
					<h2 className="text-base manrope text-black font-bold">
						Software Development Management Templates
					</h2>
							...
							<tbody>
								{rows?.map((item, i) => (
									<tr key={i} className="bg-white border-b text-xs">
										...
										<td className="px-6 py-4">{item?.project_description}</td>
								...
								<tr className="bg-white border-b text-xs">
									...
									<td className="px-6 py-4">{state?.project_name}</td>
									<td className="px-6 py-4">{state?.project_description}</td>
									<td className={`px-6 py-4`}>
					...
					<form action="" className="mt-6">
						<div className="space-y-3">
							...
							<TextInput
								...
								name={"project_description"}
								onChange={textChange}
								value={alter?.item?.project_description}
							/>
							<TextInput
								placeholder={"45,000"}
								label={"Amount"}
...
export default CreateSoftwareDevelopment;
