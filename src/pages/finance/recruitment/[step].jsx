      ...
      {state?.template === "fleet" && (
        <div>
          ...
          <ol>
            ...
            <li>50% cancellation fee applies 7 days before the event.</li>
            <li>100% penalty fee for same-day cancellations; no refunds.</li>
            <li>ICS Outsourcing isn't liable for items left in vehicles.</li>
            <li>
              Contraband goods and weapons aren't allowed in ICS vehicles.
            </li>
          </ol>
        </div>
      )}
          ...
          <>
            {accountDetails?.find((it) => it?.title === "Sort Code")?.value && (
              <h4 className="manrope text-sm page-break">
                ...
                <span>
                  {
                    accountDetails?.find((it) => it?.title === "Sort Code")
                      ?.value
                  }
                </span>
              </h4>
            ...
            {Arr1?.find((it) => it?.title === "TIN")?.value && (
              <h4 className="manrope text-sm page-break">
                TIN:{" "}
                <span>{Arr1?.find((it) => it?.title === "TIN")?.value}</span>
              </h4>
            )}
          </>
        )}
