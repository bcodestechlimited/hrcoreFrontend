	...
	const Arr1 = [
		{
			title: "Invoice No",
			value: `${
				invoiceCode?.all?.docs?.find(item => item?.type === "training")?.code ||
				""
			}${state?.invoiceId || ""}`,
		},
		{
				...
				<div className="mt-10 bg-white rounded-xl w-full p-8">
					<div className="flex justify-between">
						...
						<div className="flex gap-5">
							...
							<button
								onClick={() =>
									navigate("/finance/training/update", { state: state?._id })
								}
		...
		return (
			<section
				...
				<div className="p-2 mt-5">
					<h3 className="text-center text-sm font-bold">{state?.title}</h3>
